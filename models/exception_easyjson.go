...
func easyjson2f6dea89DecodeGithubComElasticApmServerModels(in *jlexer.Lexer, out *Exception) {
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson2f6dea89DecodeGithubComElasticApmServerModels1(in, &*v1)
					}
...
func easyjson2f6dea89EncodeGithubComElasticApmServerModels(out *jwriter.Writer, in Exception) {
	out.RawByte('{')
	first := true
	_ = first
		...
		if in.Stacktrace == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v2, v3 := range in.Stacktrace {
				...
				if v3 == nil {
					...
					easyjson2f6dea89EncodeGithubComElasticApmServerModels1(out, *v3)
				}
			}
			out.RawByte(']')
		}
...
func (v Exception) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2f6dea89EncodeGithubComElasticApmServerModels(&w, v)
...
func (v *Exception) UnmarshalJSON(data []byte) error {
	...
	easyjson2f6dea89DecodeGithubComElasticApmServerModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Exception) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2f6dea89DecodeGithubComElasticApmServerModels(l, v)
}
func easyjson2f6dea89DecodeGithubComElasticApmServerModels1(in *jlexer.Lexer, out *StacktraceFrame) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson2f6dea89EncodeGithubComElasticApmServerModels1(out *jwriter.Writer, in StacktraceFrame) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AbsPath != "" {
